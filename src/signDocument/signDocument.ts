import { WrappedDocument, SignedWrappedDocument, utils, v2, v3 } from "@govtechsg/open-attestation";
...
export const signDocument = async <T extends v2.OpenAttestationDocument | v3.OpenAttestationDocument>(
  ...
  publicKey: string,
  privateKey: string
): Promise<v2.OpenAttestationDocument ? v2.SignedWrappedDocument<T> : T extends v3.OpenAttestationDocument ? v3.SignedWrappedDocument<T> : unknown> => {
